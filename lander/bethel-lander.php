    ...
    <section class="sec_hero">
        ...
        <div class="grid-container">
            <div class="caption">
                ...
                <p><b>Bethel Residents</b> can now access the benefits and savings of solar today.</p>
                <p>You save money every month.  Guaranteed.<br>And you don’t need roof panels.  Or even a roof.  We call it Community Solar.</p>
                <p>Support <b>renewable energy</b> production from the <b>Bethel solar array</b> and see the savings right away!</p>
                <!-- <a href="#" class="button">learn more</a> -->
                <div class="getsolar_form">
                    <h2>Bethel Residents Save 10% Every Month Guaranteed!</h2>
                    <h5>SIGN UP NOW FOR FREE.<br>
                    SAVE MONEY EVERY MONTH.<br>
                    GUARANTEED IN WRITING.</h5>
                    <?= do_shortcode('[zip_form_lander_be]'); ?>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="grid-container">
            <div class="grid-x grid-margin-x">
                ...
                <div class="cell large-6 xlarge-5">
                    <div class="getsolar_form">
                        <h3>Bethel Residents Save 10% Every Month Guaranteed!</h3>
                        <h5>SIGN UP NOW FOR FREE.<br>
                        SAVE MONEY EVERY MONTH.<br>
                        GUARANTEED IN WRITING.</h5>
                        <?php /*
                        ...
                        */ ?>
                        <?= do_shortcode('[zip_form_lander_be2]'); ?>
                    </div>
                </div>
            </div>
        </div>
